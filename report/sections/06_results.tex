...
\begin{table}[H]
  ...
  \begin{tabular}{lllccl}
    ...
    \multirow{4}{*}{BAFU 2219}
      ...
      & 5c & GLOF-inclusive vs.\ non-GLOF years     & 507.0 & 0.001 & Reject \\
      & 5d & GLOF-masked vs.\ non-GLOF years        & 390.0 & 0.167 & Fail to reject \\
    \midrule
    \multirow{4}{*}{GRDC}
...
\begin{figure}[H]
  ...
  \caption{Left: 2011--2018 BAFU~2219 daily-maximum peaks on the reference GEV
           ...
           (Module~1, \S3.2). GLOF-inclusive lie above the diagonal almost entirely
           owing to 2018; GLOF-masked are broadly consistent with the 1:1 line.}
  \label{fig:pp}
\end{figure}
