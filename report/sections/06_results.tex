...
\begin{figure}[H]
  ...
  \caption{Return period plot for BAFU~2219 extended AMS (1944--2025): full (blue),
           ...
           (green) lies slightly above the reference (red) at all return periods,
           consistent with the systematic above-reference tendency of the masked annual
           maxima; the difference is not statistically significant.}
  \label{fig:gev_three}
\end{figure}
