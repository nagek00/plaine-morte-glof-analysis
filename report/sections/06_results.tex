...
\begin{figure}[H]
  ...
  \caption{Return period plot for BAFU~2219 extended AMS (1944--2025): full (blue),
           GLOF-masked 1944--2025 (green), and reference 1944--2010 (red) GEV fits with
           95\,\% delta-method confidence bands. Black crosses mark GLOF-year annual
           maxima from the full series with year labels. The 2018 event at
           $\hat{T} \approx 789$\,yr dominates the upper tail. The GLOF-masked curve
           lies slightly above the reference at all return periods, suggesting a modest
           upward tendency in natural-flood peaks even without direct GLOF contributions;
           this shift is not statistically significant (KS $p = 0.195$; Rank-Sum
           comparison~5b: $p = 0.172$; both fail to reject $H_0^{(2)}$ at $\alpha =
           0.05$).}
  \label{fig:gev_three}
\end{figure}
