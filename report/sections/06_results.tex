...
\begin{table}[H]
  ...
  \caption{GEV design quantiles [\si{m^3\per s}] for selected return periods --- BAFU~2219
           extended AMS (1944--2025), with 95\,\% delta-method confidence intervals \citep{Wilks2011}.}
...
\begin{figure}[H]
  ...
  \caption{Return period plot for BAFU~2219 extended AMS (1944--2025): full (blue),
           ...
           95\,\% delta-method confidence bands \citep{Wilks2011}. Black crosses mark GLOF-year annual
           ...
           lies slightly above the reference across all return periods.}
  \label{fig:gev_three}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Left: 2011--2018 BAFU~2219 daily-maximum peaks on the reference GEV
           ...
           (Module~1, \S3.2; \citealt{Passalacqua2026}). GLOF-inclusive lie far above the diagonal, driven by
           2018. GLOF-masked lie systematically above the 1:1 line, indicating
