...
(GLOF-inclusive) rejects $H_0^{(1)}$ in both datasets (BAFU~2219: $D_n = 0.610$, $p = 0.002$;
GRDC: $D_n = 0.776$, $p < 0.001$). Group~B (GLOF-masked) fails to reject $H_0^{(2)}$ in both
($D_n < 0.37$, $p > 0.19$).
...
\begin{table}[H]
  ...
  \begin{tabular}{llcccl}
    ...
    \multirow{2}{*}{BAFU 2219 (daily max.)}
      & A: GLOF-inclusive & 0.610 & 0.455 & 0.002    & Reject $H_0^{(1)}$ at 5\% \\
      & B: GLOF-masked    & 0.360 & 0.455 & 0.195    & Fail to reject $H_0^{(2)}$ \\
    \midrule
    \multirow{2}{*}{GRDC (daily mean)}
      & A: GLOF-inclusive & 0.776 & 0.455 & $<$0.001 & Reject $H_0^{(1)}$ at 5\% \\
      & B: GLOF-masked    & 0.318 & 0.455 & 0.321    & Fail to reject $H_0^{(2)}$ \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{lllccl}
    ...
    \multirow{3}{*}{BAFU 2219}
      & 5a & GLOF-year full vs.\ non-GLOF years       & 499.0 & 0.002 & Reject $H_0^{(1)}$ \\
      & 5b & GLOF-masked vs.\ non-GLOF years           & 382.0 & 0.182 & Fail to reject $H_0^{(2)}$ \\
      & 5c & Pre-GLOF ref vs.\ GLOF-masked peaks             & 188.0 & 0.172 & Fail to reject \\
    \midrule
    \multirow{3}{*}{GRDC}
      & 5a & GLOF-year full vs.\ non-GLOF years             & 486.0 & 0.001 & Reject $H_0^{(1)}$ \\
      & 5b & GLOF-masked vs.\ non-GLOF years                & 349.0 & 0.226 & Fail to reject $H_0^{(2)}$ \\
      & 5c & Pre-GLOF ref vs.\ GLOF-masked peaks            & 198.0 & 0.233 & Fail to reject \\
    \bottomrule
  \end{tabular}
\end{table}
