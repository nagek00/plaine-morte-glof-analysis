...
GLOF-inclusive GEV overstates the 100-year design flood by \SI{15.0}{\percent} for
BAFU~2219 and \SI{16.1}{\percent} for GRDC, driven by an upward shift in shape parameter
($\hat{\xi}: 0.160 \to 0.251$ for BAFU~2219). The inflation is dominated by the 2018
event rather than being a systematic feature of all eight GLOFs.
...
corroborates (BAFU~2219: $p = 0.167$; GRDC: $p = 0.226$). Together these confirm that
