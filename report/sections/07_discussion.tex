...
reference GEV) is the primary reason the GLOF-inclusive peaks fail the KS test. A nearly 800-year event
...
Both tests reject $H_0^{(1)}$ for GLOF-inclusive peaks in both datasets (BAFU~2219: KS $p = 0.002$,
...
After masking, neither test rejects $H_0^{(2)}$ in either dataset (BAFU~2219: KS $p = 0.195$,
Rank-Sum $p = 0.182$; GRDC: KS $p = 0.321$, Rank-Sum $p = 0.226$). The secular-change
check (5c: pre-GLOF reference vs.\ GLOF-masked peaks) also fails to reject in both
