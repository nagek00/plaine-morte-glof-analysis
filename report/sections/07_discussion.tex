...
reference GEV) is the primary reason the GLOF-inclusive fail the KS test. A nearly 800-year event
...
Both tests reject $H_0^{(1)}$ for GLOF-inclusive in both datasets (BAFU~2219: KS $p = 0.002$,
...
check (5c: pre-GLOF reference vs.\ GLOF-masked) also fails to reject in both
