...
\textit{Tests:} KS test on Group~A (GLOF-inclusive 2011--2018 peaks vs.\ reference GEV
fitted on 1944--2010); Rank-Sum comparison~5a (GLOF-year full peaks vs.\ all non-GLOF
years) as non-parametric corroboration.
...
direct GLOF signal.
\textit{Tests:} KS test on Group~B (GLOF-masked 2011--2018 peaks vs.\ reference GEV
fitted on 1944--2010); Rank-Sum comparison~5c (pre-GLOF reference vs.\ GLOF-masked
peaks) as direct non-parametric test; Rank-Sum comparison~5b (GLOF-masked peaks
vs.\ all non-GLOF years) as additional corroboration.
