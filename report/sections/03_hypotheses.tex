...
\textit{Tests:} KS test on GLOF-inclusive peaks (2011--2018) vs.\ reference GEV fitted
on 1944--2010; Rank-Sum comparison~5a (GLOF-inclusive peaks vs.\ all non-GLOF years)
as non-parametric corroboration.
...
direct GLOF signal.
\textit{Tests:} KS test on GLOF-masked peaks (2011--2018) vs.\ reference GEV fitted
on 1944--2010; Rank-Sum comparison~5c (pre-GLOF reference vs.\ GLOF-masked peaks) as
direct non-parametric test; Rank-Sum comparison~5b (GLOF-masked peaks vs.\ all
non-GLOF years) as additional corroboration.
